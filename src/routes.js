...
import AdicionarColaborador from './screens/Gerente/Colaboradores/AdicionarColaborador';
...
const AdmNavigation = () => {
  return (
    ...
    >
      ...
      <AdmDrawer.Screen name="AdicionarColaborador" component={AdicionarColaborador}/>
